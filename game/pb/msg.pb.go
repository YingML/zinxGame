...
type SyncPid struct {
	...
	Pid int32 `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"` //服务器新生村的玩家ID
}
...
type BroadCast struct {
	...
	Tp  int32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` //1-世界聊天；2-玩家位置；3-动作；4-移动之后的位置更新
